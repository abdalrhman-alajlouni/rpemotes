...
Config = {
    ...
    MenuImageUseLang = true, -- Use the chosen language background
    MenuImage = "https://i.giphy.com/media/ldgXxQ6pJ23yh6Lvjd/giphy.gif", ----[Custom banner IMGUR or GIPHY URLs go here ]--- if MenuImageUseLang is false
