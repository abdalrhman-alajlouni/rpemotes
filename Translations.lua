Config.Languages = {
	...
	['BackGroundLang'] = "https://i.giphy.com/media/ldgXxQ6pJ23yh6Lvjd/giphy.gif",
        ['emotes'] = 'Emotes 🎬',
...
['ar'] = { -- Arabic
		['BackGroundLang'] = "https://cdn.discordapp.com/attachments/632130482427002890/1078029706508632204/34573473457.png",
        ['emotes'] = 'ﺕﺎﻛﺮﺤﻟﺍ 🎬',
        ['danceemotes'] = "🕺 ﺺﻗﺮﻟﺍ ﺕﺎﻛﺮﺣ",
        ['animalemotes'] = "🐩 ﺕﺎﻧﺍﻮﻴﺤﻟﺍ ﺕﺎﻛﺮﺣ",
        ['propemotes'] = "📦  ﺕﺎﺘﻜﺠﺑﻭﻻﺍ ﺕﺎﻛﺮﺣ",
        ['favoriteemotes'] = "🌟 ﺔﻠﻀﻔﻤﻟﺍ",
        ['favoriteinfo'] = "ﺔﻠﻀﻔﻤﻟﺍ ﺔﻧﺎﺧ ﻰﻠﻋ ﺎﻬﻌﺿﻮﻟ ﺎﻨﻫ ﻦﻣ ﺔﻛﺮﺣ ﺮﺘﺧﺍ",
        ['rfavorite'] = "ﺔﻠﻀﻔﻤﻟﺍ ﻂﺒﺿ ﺓﺩﺎﻋﺍ",
        ['prop2info'] = "❓ ﺔﻳﺎﻬﻨﻟﺍ ﻲﻓ ﺓﺩﺪﺤﻣ ﻥﻮﻜﺗ ﺕﺎﺘﻜﺠﺑﻭﻻﺍ ﺕﺎﻛﺮﺣ",
        ['set'] = "ﻊﺿﻭ (",
        ['setboundemote'] = ") لت؟ ﺔﻃﻮﺑﺮﻣ ﺔﻛﺮﺣ ﻥﻮﻛ",
        ['newsetemote'] = "~w~ ﺎﻬﻣﺍﺪﺨﺘﺳﻹ ~g~CapsLock~w~ ﻰﻠﻋ ﻂﻐﺿﺍ , ﺔﻃﻮﺑﺮﻤﻟﺍ ﻚﺘﻛﺮﺣ ﻲﻫ",
        ['cancelemote'] = " ﺔﻛﺮﺤﻟﺍ ﺀﺎﻐﻟﺍ 🚷",
        ['cancelemoteinfo'] = "ﺔﻴﻟﺎﺤﻟﺍ ﺔﻛﺮﺤﻟﺍ ﺐﻌﻟ ﺀﺎﻐﻟﻻ ~r~X~w~",
		['walkingstyles'] = "ﻲﺸﻤﻟﺍ ﺐﻴﻟﺎﺳﺍ 🚶🏻‍",
        ['resetdef'] = "ﻲﻌﻴﺒﻄﻟﺍ ﻊﺿﻮﻠﻟ ﺎﻬﺗﺩﺎﻋﺍ",
        ['normalreset'] = "ﻱﺩﺎﻌﻟﺍ (ﻦﻴﻴﻌﺗ ﺓﺩﺎﻋﺍ)",
        ['moods'] = "ﺝﺍﺰﻤﻟﺍ 😒",
        ['infoupdate'] = "ﺕﺎﺣﺍﺮﺘﻗﻼﻟ & ﻕﻮﻘﺣ 🙏🏻",
        ['infoupdateav'] = "ﺕﺎﻣﻮﻠﻌﻤﻟﺍ (ﺡﺎﺘﻣ ﺚﻳﺪﺤﺘﻟﺍ)",
        ['infoupdateavtext'] = "ﺎﻨﻫ ﻦﻣ ﻪﻴﻠﻋ ﻝﻮﺼﺤﻟﺎﺑ ﻢﻗ , ﺡﺎﺘﻣ ﺪﻳﺪﺟ ﺚﻳﺪﺤﺗ ﺪﺟﻮﻳ : ~y~https://github.com/TayMcKenzieNZ/rpemotes~w~",
        ['suggestions'] = "؟ﺕﺎﺣﺍﺮﺘﻗﺍ ﻚﻳﺪﻟ",
        ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ ﺕﺎﻛﺮﺣ ﻭﺍ ﺕﺎﺣﺍﺮﺘﻗﺍ ﻱﻷ ﻡﺍ ﻒﻳﺎﻓ ﻯﺪﺘﻨﻣ ﻰﻠﻋ! ✉️",
        ['notvaliddance'] = "ﺔﺣﺎﺘﻣ ﺮﻴﻏ ﺔﺼﻗﺮﻟﺍ ﻩﺬﻫ",
        ['notvalidemote'] = "ﺔﺣﺎﺘﻣ ﺮﻴﻏ ﺔﻛﺮﺤﻟﺍ ﻩﺬﻫ.",
        ['nocancel'] = "ﺎﻬﺋﺎﻐﻟﻻ ﺔﻛﺮﺣ ﺪﺟﻮﻳ ﻻ.",
        ['maleonly'] = "ﺓﺭﺬﻌﻤﻟﺍ ،ﺭﻮﻛﺬﻠﻟ ﻂﻘﻓ ﺔﺼﺼﺨﻣ ﺔﻛﺮﺤﻟﺍ ﻩﺬﻫ!",
        ['emotemenucmd'] = "ﺕﺎﻛﺮﺤﻟﺍ ﺔﺋﺎﻗ ﺢﺘﻔﻟ emotemenu/ ﺮﻣﺍ ﻡﺪﺨﺘﺳﺍ",
        ['shareemotes'] = "👫 ﺔﻛﺮﺘﺸﻤﻟﺍ ﺕﺎﻛﺮﺤﻟﺍ",
        ['shareemotesinfo'] = "ﻪﻌﻣ ﺕﺎﻛﺮﺣ ﻞﻤﻌﻟ ﺐﻳﺮﻗ ﺺﺨﺷ ﺓﻮﻋﺩ",
        ['sharedanceemotes'] = "🕺 ﺔﻛﺮﺘﺸﻤﻟﺍ ﺕﺎﺼﻗﺮﻟﺍ",
        ['notvalidsharedemote'] = "ﺔﺣﺎﺘﻣ ﺔﻛﺮﺘﺸﻣ ﺔﻛﺮﺣ ﺖﺴﻴﻟ ﻩﺬﻫ.",
        ['sentrequestto'] = "ﻰﻟﺍ ﺐﻠﻄﻟﺍ ﻝﺎﺳﺭﺍ ﻢﺗ ~y~",
        ['nobodyclose'] = "ﺺﺨﺷ ﺪﺟﻮﻳ ﻻ ~r~ﻚﻴﻠﻋ ﺐﻳﺮﻗ~w~ ﺔﻳﺎﻔﻛ.",
        ['doyouwanna'] = "~y~Y~w~ ﻝﻮﺒﻘﻠﻟ, ~r~L~w~ ﺾﻓﺮﻠﻟ (~g~",
        ['refuseemote'] = "ﺔﻛﺮﺤﻟﺍ ﺾﻓﺭ ﻢﺗ",
        ['makenearby'] = "ﺐﻌﻠﻳ ﺐﻋﻻ ﺏﺮﻗﺍ ﻞﻌﺠﺑ ﻢﻗ",
        ['useleafblower'] = "ﻂﻐﺿﺍ ~y~G~w~ ﺥﺎﻔﻨﻣ ﺔﻗﺭﻭ ﻡﺍﺪﺨﺘﺳﻹ.",
        ['camera'] = "ﻂﻐﺿﺍ ~y~G~w~ ﺍﺮﻴﻣﺎﻜﻟﺍ ﺵﻼﻓ ﻡﺍﺪﺨﺘﺳﻻ.",
        ['makeitrain'] = "ﻂﻐﺿﺍ ~y~G~w~ ﺮﻄﻤﺗ ﺎﻬﻠﻌﺠﻟ.",
        ['pee'] = "ﻰﻠﻋ ﺔﻟﻮﻄﻣ ﺔﻄﻐﺿ ﻂﻐﺿﺍ ~y~G~w~ ﺔﺟﺎﺤﻟﺍ ﺀﺎﻀﻘﻟ.",
        ['spraychamp'] = "ﻰﻠﻋ ﺔﻟﻮﻄﻣ ﺔﻄﻐﺿ ﻂﻐﺿﺍ ~y~G~w~ ﺎﻴﻧﺎﺒﻤﺸﻟﺍ ﺵﺮﻟ",
        ['stun'] = "ﻂﻐﺿﺍ ~y~G~w~ ﺔﻳﺮﺼﺣ ﺔﻴﻗﺪﻨﺑ ﻡﺍﺪﺨﺘﺳﻻ",
        ['vape'] = "ﻂﻐﺿﺍ ~y~G~w~ ﺐﻴﻔﻟﺍ ﻦﻴﺧﺪﺘﻟ.",
        ['bound'] = "ـﺑ ﻂﺒﺗﺮﻣ ",
        ['to'] = "لـ",
        ['currentlyboundemotes'] = " ﺎﻴﻟﺎﺣ ﺔﻠﻐﺸﻤﻟﺍ ﺕﺎﻛﺮﺤﻟﺍ:",
        ['notvalidkey'] = "ﺔﺤﻟﺎﺻ ﺮﻴﻏ ﺔﺴﺒﻛ",
        ['keybinds'] = "🔢 ﺢﻴﺗﺎﻔﻟﺍ ﺕﺎﺴﺒﻛ",
        ['keybindsinfo'] = "ﻡﺍﺪﺨﺘﺳﺍ",
        ['searchemotes'] = "🔍 ﺔﻛﺮﺣ ﻦﻋ ﺚﺤﺑ",
        ['searchinputtitle'] = "ﺚﺤﺑ:",
        ['searchmenudesc'] = "%s ـﻟ ﺔﺠﻴﺘﻧ '~r~%s~w~':",
        ['searchnoresult'] = " ﺚﺤﺒﻠﻟ ﺔﺠﻴﺘﻧ ﺪﺟﻮﻳ ﻻ '~r~%s~w~'.",
        ['searchshifttofav'] = "ﻰﻠﻋ ﺔﻟﻮﻄﻣ ﺔﻄﻐﺿ ﻂﻐﺿﺍ L-Shift ﺔﻠﻀﻔﻤﻟﺍ ﻲﻓ ﺎﻬﻌﺿﻮﻟ",
        ['searchcantsetfav'] = "ﺔﻠﻀﻔﻤﻟﺍ ﻲﻓ ﺎﻬﻌﺿﻭ ﻊﻴﻄﺘﺴﺗ ﻻ ﺔﻛﺮﺘﺸﻤﻟﺍ ﺕﺎﻛﺮﺤﻟﺍ",
        ['invalidvariation'] = "ﻲﻫ ﺔﺤﻴﺤﺼﻟﺍ ﺕﺍﺭﺎﻴﺘﺧﻻﺍ ,ﺢﻟﺎﺻ ﺮﻴﻏ ﺮﺸﺘﺴﻜﺗ : %s",
        ['firework'] = "ﻂﻐﺿﺍ ~y~G~w~ ﺔﻳﺭﺎﻨﻟﺍ ﺏﺎﻌﻟﻻﺍ ﻡﺍﺪﺨﺘﺳﻻ",
        ['poop'] = "ﻂﻐﺿﺍ ~y~G~w~ 2 ﺔﺟﺎﺤﻟﺍ ﺀﺎﻀﻘﻟ",
        ['puke'] = "ﻂﻐﺿﺍ ~y~G~w~ ﺆﻴﻘﺘﻠﻟ",
        ['btn_select'] = "ﺭﺎﻴﺘﺧﺍ",
        ['btn_back'] = "ﺓﺩﻮﻌﻟﺍ",
        ['btn_switch'] = "ﺔﻛﺮﺣ",
        ['btn_increment'] = "ﺓﺩﺎﻳﺯ",
		 ['dead'] = "!ﺖﻴﻣ ﺖﻧﺍﻭ ﺕﺎﻛﺮﺤﻟﺍ ﻡﺍﺪﺨﺘﺳﺍ ﻚﻨﻜﻤﻳ ﻻ",
        ['swimming'] = "ﺔﺣﺎﺒﺴﻟﺍ ﺀﺎﻨﺛﺍ ﺕﺎﻛﺮﺤﻟﺍ ﻡﺍﺪﺨﺘﺳﺍ ﻚﻨﻜﻤﻳ ﻻ",
        ['notvalidpet'] = "RUH ROH! ﻪﻓﺎﺸﺘﻛﺍ ﻢﺗ ﺢﻴﺤﺻ ﺮﻴﻏ ﻒﻴﻟﺍ ﻥﺍﻮﻴﺣ ﺯﺍﺮﻃ 🐕!",
        ['animaldisabled'] = "ﺮﻓﺮﻴﺴﻟﺍ ﺍﺬﻫ ﻲﻓ ﺔﻠﻌﻔﻣ ﺮﻴﻏ ﺕﺎﻧﺍﻮﻴﺤﻟﺍ ﺕﺎﻛﺮﺣ !ﺓﺭﺬﻌﻤﻟﺍ",
        ['adultemotedisabled'] = "Bonk! ﺔﻠﻄﻌﻣ ﻥﺎﺒﺸﻟﺍ ﺕﺎﻛﺮﺣ 🔞",
        ['toggle_instructions'] = "ﺕﺎﻤﻴﻠﻌﺘﻟﺍ ﻞﻳﺪﺒﺘﺑ ﻢﻗ",
        ['exit_binoculars'] = "ﺭﺎﻈﻨﻤﻟﺍ ﻦﻣ ﺝﻭﺮﺨﻟﺍ",
        ['toggle_binoculars_vision'] = "ﺔﻳﺅﺮﻟﺍ ﻉﺎﺿﻭﺃ ﻦﻴﺑ ﻞﻳﺪﺒﺘﻟﺍ",
        ['exit_news'] = "ﺭﺎﺒﺧﻻﺍ ﺍﺮﻴﻣﺎﻛ ﻦﻣ ﺝﻭﺮﺨﻟﺍ",
        ['toggle_news_vision'] = "ﺔﻳﺅﺮﻟﺍ ﻉﺎﺿﻭﺃ ﻦﻴﺑ ﻞﻳﺪﺒﺘﻟﺍ",
        ['edit_values_newscam'] = "ﺭﺎﺒﺧﻷﺍ ﺺﻧ ﺮﻳﺮﺤﺗ",
        ['not_in_a_vehicle'] = "ﺓﺭﺎﻴﺴﻟﺍ ﻲﻓ ﻙﺩﻮﺟﻭ ﺀﺎﻨﺛﺃ ﻦﺸﻴﻤﻴﻧﻻﺍ ﻩﺬﻫ ﻞﻴﻐﺸﺗ ﻚﻨﻜﻤﻳ ﻻ",
        ['in_a_vehicle'] = "ﺓﺭﺎﻴﺴﻟﺍ ﻲﻓ ﻙﺩﻮﺟﻭ ﺀﺎﻨﺛﺃ ﻦﺸﻴﻤﻴﻧﻻﺍ ﻩﺬﻫ ﻞﻴﻐﺸﺗ ﻂﻘﻓ ﻚﻨﻜﻤﻳ 🚷",
        ['no_anim_crawling'] = "ﻒﺣﺰﻟﺍ ﺀﺎﻨﺛﺃ ﻦﺸﻴﻤﻴﻧﻻﺍ ﻞﻴﻐﺸﺗ ﻚﻨﻜﻤﻳ ﻻ",
	},
}
